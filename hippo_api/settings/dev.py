...
SECRET_KEY = 'q!x*i-b(xsazd-&xq8ur6$1vau)1!91mzzei^)h@em8dzbh^=u'
...
CORS_ORIGIN_WHITELIST = (
    # 'www.hippo.com:8080', #如果这样写不行的话，就加上协议(http://www.hippo.com:8080，因为不同的corsheaders版本可能有不同的要求)
